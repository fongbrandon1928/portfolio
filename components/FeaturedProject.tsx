    ...
    >
      <div ref={ref} className="mx-auto max-w-5xl">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-card)] card-glow"
        >
          <div className="grid gap-0 lg:grid-cols-2">
            ...
            <div className="relative min-h-[300px] lg:min-h-0">
              <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-bg-card)] via-transparent to-transparent z-10 lg:block hidden" />
              <img
